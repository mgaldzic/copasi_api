...
SWIGEXPORT void JNICALL Java_org_sbml_libsbml_libsbmlJNI_Model_1convertParametersToLocals(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Model *arg1 = (Model *) 0 ;
...
SWIGEXPORT void JNICALL Java_org_sbml_libsbml_libsbmlJNI_Model_1setSpeciesReferenceConstantValue(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_) {
  Model *arg1 = (Model *) 0 ;
