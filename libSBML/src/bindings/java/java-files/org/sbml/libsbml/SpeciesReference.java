...
public class SpeciesReference extends SimpleSpeciesReference {
   ...
   * <p>
   * @note Upon the addition of a {@link SpeciesReference} object to an
   * {@link SBMLDocument} (e.g., using Model.addSpeciesReference()), the SBML
   * Level, SBML Version and XML namespace of the document 
   * <em>override</em> the values used when creating the {@link SpeciesReference} object via
   ...
   * values at the time of creation of a {@link SpeciesReference} is an important
 ...
 public SpeciesReference(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
   ...
   * <p>
   * @note Upon the addition of a {@link SpeciesReference} object to an
   * {@link SBMLDocument} (e.g., using Model.addSpeciesReference()), the SBML XML
   * namespace of the document <em>overrides</em> the value used when creating
   * the {@link SpeciesReference} object via this constructor.  This is necessary
   * to ensure that an SBML document is a consistent structure.
   * Nevertheless, the ability to supply the values at the time of creation
   * of a {@link SpeciesReference} is an important aid to producing valid SBML.
 ...
 public SpeciesReference cloneObject() {
   ...
   * <ul>
   * <li> Sets attribute 'stoichiometry' to <code>1</code>.0
 ...
 public int setStoichiometry(double value) {
   ...
   * return <code>false</code> although getStoichiometry() will return <code>1</code>.0) if the
 ...
 public int setConstant(boolean flag) {
   ...
   * <p>
   * @note In SBML Level&nbsp;2, the 'stoichiometry' attribute of this
   * {@link SpeciesReference} object will be reset to a default value (<code>1</code>.0) if
 ...
 public int unsetStoichiometryMath() {
   ...
   * {@link SpeciesReference} object will be just reset to a default value (<code>1</code>.0)
   ...
   * although getStoichiometry() will return <code>1</code>.0) if the
   * 'stoichiometryMath' subelement has been set, otherwise the attribute
   * will be just reset to the default value (<code>1</code>.0) (and
