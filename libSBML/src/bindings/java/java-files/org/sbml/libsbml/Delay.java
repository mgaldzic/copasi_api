...
public class Delay extends SBase {
   ...
   * {@link Delay}
   * <p>
   * @note Upon the addition of a {@link Delay} object to an {@link SBMLDocument} (e.g.,
   ...
   * the {@link Delay} object via this constructor.  This is necessary to ensure
   * that an SBML document is a consistent structure.  Nevertheless, the
   * ability to supply the values at the time of creation of a {@link Delay} is an
 ...
 public Delay(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
   ...
   * <p>
   * @note Upon the addition of a {@link Delay} object to an {@link SBMLDocument} (e.g.,
   * using Model.addDelay()), the SBML XML namespace of the document 
   * <em>overrides</em> the value used when creating the {@link Delay} object via this
   * constructor.  This is necessary to ensure that an SBML document is a
   * consistent structure.  Nevertheless, the ability to supply the values
   * at the time of creation of a {@link Delay} is an important aid to producing
