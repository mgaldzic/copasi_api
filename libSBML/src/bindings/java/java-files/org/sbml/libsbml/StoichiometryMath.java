...
public class StoichiometryMath extends SBase {
   ...
   * {@link SBMLDocument} (e.g., using Model.addStoichiometryMath()), the SBML
   * Level, SBML Version and XML namespace of the document 
   * <em>override</em> the values used when creating the {@link StoichiometryMath} object
   * via this constructor.  This is necessary to ensure that an SBML
   * document is a consistent structure.  Nevertheless, the ability to
   * supply the values at the time of creation of a {@link StoichiometryMath} is an
 ...
 public StoichiometryMath(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
   ...
   * <p>
   * @note Upon the addition of a {@link StoichiometryMath} object to an
   * {@link SBMLDocument} (e.g., using Model.addStoichiometryMath()), the SBML XML
   * namespace of the document <em>overrides</em> the value used when creating
   * the {@link StoichiometryMath} object via this constructor.  This is necessary
   * to ensure that an SBML document is a consistent structure.
   * Nevertheless, the ability to supply the values at the time of creation
   * of a {@link StoichiometryMath} is an important aid to producing valid SBML.
