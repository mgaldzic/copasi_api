 ...
 * constructors (e.g., <a
 * href='org/sbml/libsbml/{@link Species}.html'>{@link Species}()</a> ), and
 ...
 * <code>&lt;listOfSpecies gt;</code> list in the model.  Subsequently,
...
public class Model extends SBase {
 ...
 public Model(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
   ...
   * using Model.addModel()), the SBML XML namespace of the document 
 ...
 */
 public void convertParametersToLocals() {
    libsbmlJNI.Model_convertParametersToLocals(swigCPtr, this);
  }
 ...
 */
 public void setSpeciesReferenceConstantValue() {
    libsbmlJNI.Model_setSpeciesReferenceConstantValue(swigCPtr, this);
  }
