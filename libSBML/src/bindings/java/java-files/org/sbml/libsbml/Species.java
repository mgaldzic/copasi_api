...
public class Species extends SBase {
 ...
 public Species(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
   ...
   * <p>
   * @note Upon the addition of a {@link Species} object to an {@link SBMLDocument} (e.g.,
   * using Model.addSpecies()), the SBML XML namespace of the document 
...
this topic and the SBML unit system.
 ...
 public boolean isSetName() {
  ...
  /**
   * Predicate returning <code>true</code> if this {@link Species}'s
 ...
 public boolean isSetSpatialSizeUnits() {
   ...
   * this {@link Species}'s 'units' attribute has been set.
   * <p>
...
<p>
 ...
 public int setSubstanceUnits(String sid) {
  ...
  /**
   * (SBML Level&nbsp;2 Versions&nbsp;1&ndash;2) Sets the 'spatialSizeUnits' attribute of this {@link Species}.
   * <p>
   * @param sid the identifier of the unit to use.
   * <p>
   * @warning In versions of SBML Level~2 before Version&nbsp;3, the class
 ...
 public int setConstant(boolean value) {
  ...
  /**
   * Sets the value of the 'conversionFactor' attribute of this {@link Species}.
   * <p>
 ...
 public int unsetSpatialSizeUnits() {
  ...
  /**
   * Unsets the 'units' attribute value of this {@link Species}.
   * <p>
   * @return integer value indicating success/failure of the
   * function.  The possible values
   * returned by this function are:
 ...
 public int unsetCharge() {
  ...
  /**
   * Unsets the 'conversionFactor' attribute value of this {@link Species}.
   * <p>
   * @return integer value indicating success/failure of the
   * function. The possible values
   * returned by this function are:
