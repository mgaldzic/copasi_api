 ...
 * 'math' <em>should</em> (in SBML Level&nbsp;2 Version&nbsp;4 and later) or 
 ...
 * the formula <em>should</em> (in SBML Level&nbsp;2 Version&nbsp;4 and
 * later) or <em>must</em> (in SBML releases prior to Level&nbsp;2
 ...
 * formula <em>should</em> (in SBML Level&nbsp;2 Version&nbsp;4 and
 * later) or <em>must</em> (in SBML releases prior to Level&nbsp;2
