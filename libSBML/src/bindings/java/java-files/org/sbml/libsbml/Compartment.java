...
public class Compartment extends SBase {
 ...
 public Compartment cloneObject() {
   ...
   * <li> (Applies to Level&nbsp;1 models only) Sets attribute 'volume' to <code>1</code>.0
   * </ul>
   */
...
this topic and the SBML unit system.
 ...
 public boolean isSetCompartmentType() {
   ...
   * this {@link Compartment} has been set, <code>false</code> otherwise.
   * <p>
   * @see #isSetVolume()
 ...
 public boolean isSetSize() {
   ...
   * above) of this {@link Compartment} has been set, <code>false</code> otherwise.
   * <p>
   * @see #isSetSize()
   ...
   * default value (<code>1</code>.0) and therefore this method will always return 
