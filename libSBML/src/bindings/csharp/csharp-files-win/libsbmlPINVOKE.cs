...
class libsbmlPINVOKE {
  ...
  public static extern void Model_convertParametersToLocals(HandleRef jarg1);

  [DllImport("libsbmlcs", EntryPoint="CSharp_Model_setSpeciesReferenceConstantValue")]
  public static extern void Model_setSpeciesReferenceConstantValue(HandleRef jarg1);
