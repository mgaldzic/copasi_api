...
SWIGEXPORT void SWIGSTDCALL CSharp_Model_convertParametersToLocals(void * jarg1) {
  Model *arg1 = (Model *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_Model_setSpeciesReferenceConstantValue(void * jarg1) {
  Model *arg1 = (Model *) 0 ;
...
SWIGEXPORT Parameter * SWIGSTDCALL CSharp_LocalParameterUpcast(LocalParameter *objectRef) {
    return (Parameter *)objectRef;
}

SWIGEXPORT ListOfParameters * SWIGSTDCALL CSharp_ListOfLocalParametersUpcast(ListOfLocalParameters *objectRef) {
    return (ListOfParameters *)objectRef;
}
